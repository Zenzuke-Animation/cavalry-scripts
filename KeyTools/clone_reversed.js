/**
 * Clones selected keyframes and pastes them in REVERSE starting at the current playhead position.
 */
...
if (keyIds && keyIds.length > 0) {
    ...
    if (copiedKeyframes.length > 0) {
        ...
        for (let kf of sorted) {
            ...
            // Mirror the offset against the total duration
            let targetFrame = origFrame + (duration - frameOffset);
        ...
        console.log("Cloned and reversed " + pastedCount + " keyframes.");
    }
} else {
